...
public class NewXmlComplexFeatureParser extends NewXmlFeatureParser<FeatureType, Feature> {
     ...
     * @throws IOException
     */
    public NewXmlComplexFeatureParser(InputStream getFeatureResponseStream, FeatureType targetType,
        ...
        try {
            ...
            while ((nextAttribute = parseNextAttribute(this.targetType)) != null) {
                if (!Property.class.isAssignableFrom(nextAttribute.value.getClass())) {
                    featureBuilder.append(nextAttribute.name, new AttributeImpl(nextAttribute.value,
    ...
    private ReturnAttribute parseNextAttribute(ComplexType complexType)
        ...
        do {
            tagType = parser.next();
        } while (tagType != XmlPullParser.START_TAG && tagType != XmlPullParser.END_TAG
        ...
        if (tagType == XmlPullParser.START_TAG) {
            ...
            if (descriptor != null) {
                ...
                if (href != null) {
                    ...
                    return new ReturnAttribute(id, currentTagName, hrefAttribute, href);
                }
                // ComplexType or an AttributeType.
                    ...
                    if (type.getBinding() == Collection.class && Types.isSimpleContentType(type)) {
                        ...
                        if (value != null || descriptor.isNillable()) {
                            ...
                            AttributeDescriptor simpleContentDescriptor = new AttributeDescriptorImpl(
                                    simpleContentType, ComplexFeatureConstants.SIMPLE_CONTENT, 1, 1,
                                    true, (Object) null);
                            list.add(new AttributeImpl(convertedValue, simpleContentDescriptor,
                                    null));
                        }
                    ...
                    Object attributeValue = super.parseAttributeValue(
