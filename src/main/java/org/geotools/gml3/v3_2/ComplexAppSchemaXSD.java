 ...
 * @source $URL$
 */
public class ComplexAppSchemaXSD extends XSD {
     ...
     */
    private ComplexApplicationSchemaConfiguration configuration;
     ...
     * @param resolver
     */
    public ComplexAppSchemaXSD(String namespaceUri, String schemaLocation, SchemaResolver resolver) {
     ...
     * @param configuration
     */
    public void setConfiguration(ComplexApplicationSchemaConfiguration configuration) {
